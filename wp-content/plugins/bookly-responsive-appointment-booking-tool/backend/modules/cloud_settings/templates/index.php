               ...
               <div class="card-body">
                   <div class="tab-content">
                       ...
                       <div class="tab-pane" id="bookly-account-notifications-tab" style="min-height: 200px;">
                           ...
                           <div class="custom-control custom-checkbox">
                               <input class="custom-control-input" type="checkbox" id="bookly_cloud_notify_weekly_summary" name="bookly_cloud_notify_weekly_summary" <?php checked( get_option( 'bookly_cloud_notify_weekly_summary' ) ) ?>>
                               <label class="custom-control-label" for="bookly_cloud_notify_weekly_summary"><span><?php esc_html_e( 'Send weekly summary to administrators', 'bookly' ) ?></span></label>
                           </div>
                       </div>
